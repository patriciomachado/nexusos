...
import { 
    ...
    Building2, MapPin, Phone, Award, CheckCircle2, ChevronRight, X, Eye, Image as ImageIcon
} from 'lucide-react'
...
export function DynamicCatalogContent({ slug }: { slug: string }) {
    ...
    return (
        <div className="min-h-screen bg-[#0A0D14] text-slate-100 font-sans selection:bg-emerald-500 selection:text-black">
            ...
            <header className="sticky top-0 z-40 bg-[#0F1420]/80 backdrop-blur-xl border-b border-slate-800/80 shadow-2xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredDevices.length === 0 ? (
                            <div className="col-span-full py-20 text-center bg-[#111622] border border-dashed border-slate-800 rounded-3xl p-8 space-y-3">
                                ...
                                <h3 className="font-bold text-base text-slate-300">Nenhum aparelho encontrado com estes filtros</h3>
                                <p className="text-xs text-slate-500 max-w-sm mx-auto">Tente selecionar 'Todas as Marcas' ou limpar o campo de busca.</p>
                            </div>
                        ) : (
