        ...
        <div className="animate-fade-in pb-12 bg-background min-h-screen transition-colors duration-300">
            ...
            <div className="p-8 lg:p-12 max-w-screen-2xl mx-auto space-y-10">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6">
                    <div className="space-y-2">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[11px] font-black uppercase tracking-wider text-primary/60">CRM & Relacionamento</span>
                        </div>
                ...
                <div className="bg-card/40 backdrop-blur-3xl border border-white/5 rounded-3xl p-6 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
                    ...
                    <div className="flex items-center gap-4 w-full md:w-auto">
                        <div className="flex -space-x-2">
                            ...
                            <div className="w-8 h-8 rounded-full border-2 border-background bg-card flex items-center justify-center text-[11px] font-black text-muted-foreground">
                                +{customers?.length || 0}
                            </div>
                        </div>
                        <span className="text-[11px] font-black uppercase tracking-widest text-muted-foreground">Base Consolidada</span>
                    </div>
                </div>
                ...
                {customers && customers.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                        {customers.map((c) => (
                            <Link
                                key={c.id}
                                href={`/customers/${c.id}`}
                                className="group relative p-8 rounded-3xl glass-premium bg-card/65 backdrop-blur-3xl border border-white/5 hover:border-primary/30 hover:shadow-primary/5 transition-all duration-300 hover:-translate-y-2 overflow-hidden block shadow-2xl"
                            >
                                ...
                                <div className="relative space-y-6">
                                    <div className="flex items-start justify-between">
                                        <div className="flex items-center gap-4">
                                            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/10 to-blue-500/10 border border-primary/20 flex items-center justify-center text-primary font-black text-2xl shadow-inner group-hover:scale-110 transition-transform">
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        {c.phone && (
                                            <div className="flex items-center gap-4 p-3 rounded-2xl bg-muted/10 border border-white/5 group-hover:bg-primary/5 transition-colors">
                                                <div className="w-8 h-8 rounded-lg bg-card border border-white/5 flex items-center justify-center text-muted-foreground group-hover:text-primary transition-colors">
                                    ...
                                    <div className="pt-4 flex items-center justify-between border-t border-white/5">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[11px] font-black uppercase tracking-wider text-muted-foreground">Histórico Limpo</span>
                                        </div>
                                        <div className="flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-xl text-[11px] font-black uppercase tracking-widest group-hover:bg-primary group-hover:text-primary-foreground transition-all">
                                            Acessar Perfil
                    ...
                    <div className="mt-12 p-24 text-center bg-card/40 backdrop-blur-3xl border border-white/5 rounded-3xl shadow-2xl">
                        <div className="w-32 h-32 rounded-3xl bg-primary/10 border border-primary/20 flex items-center justify-center mx-auto mb-10 group hover:rotate-12 transition-transform">
