    ...
    if (user?.role !== 'admin') {
        return (
            <div className="flex flex-col items-center justify-center min-h-[80vh] p-8 text-center space-y-8 animate-fade-in">
                <div className="p-8 rounded-3xl bg-rose-500/10 text-rose-500 shadow-2xl relative">
                    ...
                    <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-6">
                        <div className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[11px] font-black uppercase tracking-wider text-indigo-500/60">Identidade Corporativa</span>
                            </div>
                        ...
                        <div className="flex items-center gap-4 bg-muted/30 p-2 rounded-2xl border border-white/5">
                            ...
                            <span className="text-[11px] font-black uppercase tracking-widest text-muted-foreground pr-4">Visibilidade Pública Online</span>
                        </div>
                    </div>

                    <div className="p-10 rounded-3xl glass-premium bg-card/65 border border-white/5 backdrop-blur-3xl shadow-2xl overflow-hidden relative group transition-all duration-300 hover:scale-[1.01] hover:shadow-primary/5">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <div className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[11px] font-black uppercase tracking-wider text-primary/60">Gateways de Recebimento</span>
                            </div>
                            <h2 className="text-3xl font-black text-foreground tracking-tighter">Métodos de Pagamento</h2>
                        </div>
                        <div className="p-10 rounded-3xl glass-premium bg-card/65 border border-white/5 backdrop-blur-3xl shadow-2xl relative overflow-hidden group transition-all duration-300 hover:scale-[1.01] hover:border-primary/20 hover:shadow-primary/5">
