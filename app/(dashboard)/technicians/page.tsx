...
<Link
 ...
 >
                ...
                {technicians && technicians.length > 0 ? (
                                ...
                                <div className="relative z-10 flex flex-col h-full">
                                    <div className="flex items-start justify-between mb-6">
                                        <div className="flex items-center gap-4">
                                            <div className="w-16 h-16 rounded-2xl border border-border flex items-center justify-center text-orange-400 font-bold text-2xl shadow-inner relative overflow-hidden">
                                    ...
                                    {t.specialties && t.specialties.length > 0 && (
                                        <div className="flex flex-wrap gap-2 mb-6">
                                            {(t.specialties as string[]).slice(0, 3).map((s: string) => (
                                                <span key={s} className="px-2.5 py-1 rounded-lg text-xs font-bold bg-orange-500/10 text-orange-400 border border-orange-500/20">
                                                    {s}
                                                </span>
                                            ))}
                                        </div>
                                    ...
                                    <div className="mt-6 pt-5 border-t border-border/10 flex items-center justify-between">
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <span className="text-xs font-bold text-emerald-500">Disponível</span>
                                        </div>
                    ...
                    <div className="mt-12 p-20 text-center bg-muted/40 border border-border rounded-2xl">
