    ...
    return (
        <div className="relative w-full">
            ...
            <Popover.Root open={isOpen} onOpenChange={setIsOpen}>
                ...
                <Popover.Portal>
                    <Popover.Content 
                        className="z-[9999] w-[var(--radix-popover-trigger-width)] overflow-hidden rounded-[2rem] bg-card/95 border border-white/10 shadow-2xl backdrop-blur-3xl animate-in fade-in zoom-in-95 duration-200"
                        sideOffset={8}
                        align="start"
                    >
