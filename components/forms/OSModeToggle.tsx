        ...
        <div className="flex items-center gap-3 px-4 md:px-0 mb-4">
            ...
            <div className="flex gap-1 p-1 bg-white/5 border border-white/5 rounded-xl">
                <button
                    ...
                    className={`px-4 py-2 rounded-lg text-[11px] font-black uppercase tracking-widest transition-all flex items-center gap-1.5 ${mode === 'quick'
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg text-[11px] font-black uppercase tracking-widest transition-all flex items-center gap-1.5 ${mode === 'guided'
                        ? 'bg-indigo-500/20 text-indigo-400 border border-indigo-500/20 shadow-[0_0_12px_rgba(99,102,241,0.15)]'
                        : 'text-muted-foreground hover:text-muted-foreground'
                        }`}
                >
