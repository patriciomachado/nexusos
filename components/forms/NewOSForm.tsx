                ...
                <div className="flex items-center gap-2 md:gap-6 shrink-0">
                    ...
                    <div className="flex gap-2">
                        <button
                            type="button"
                            onClick={() => router.back()}
                            className="px-4 md:px-6 py-2.5 md:py-3 rounded-xl border border-white/5 bg-white/5 text-[11px] md:text-[11px] font-black uppercase tracking-widest hover:bg-white/10 transition-all flex items-center gap-2"
                        >
                        ...
                        <button
                            ...
                            className="px-5 md:px-8 py-2.5 md:py-3 rounded-xl bg-indigo-500 text-white text-[11px] md:text-[11px] font-black uppercase tracking-widest hover:bg-indigo-400 transition-all shadow-lg shadow-indigo-500/20 flex items-center gap-2 disabled:opacity-50"
                        >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="pt-4 border-t border-white/5 flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl text-[11px] font-black uppercase tracking-widest transition-all flex items-center gap-2 ${form.turns_on
