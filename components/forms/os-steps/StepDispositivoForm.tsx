...
export default function StepDispositivoForm({ form, setForm, onNext, onBack }: Props) {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="text-center space-y-2 py-4">
                <div className="w-16 h-16 rounded-2xl bg-orange-500/20 text-orange-400 flex items-center justify-center mx-auto border border-orange-500/20">
            ...
            <div className="bg-card/40 border border-border/60 rounded-2xl p-6 md:p-8 shadow-inner space-y-6">
                ...
                <div className="pt-4 border-t border-border/60">
                    <div className="flex items-center justify-between">
                        <div>
                            <span className="text-sm font-semibold text-foreground/80">Aparelho liga?</span>
 ...
 className={`px-4 py-2.5 rounded-xl text-[13px] font-semibold transition-all flex items-center gap-2 ${form.turns_on
 ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 '
 : 'bg-foreground/[0.03] text-muted-foreground border border-border/60'
 }`}
 >
 ...
 type="button"
 onClick={handleNext}
 className="px-8 py-4 rounded-2xl bg-orange-500 text-white text-sm font-semibold hover:bg-orange-400 transition-all flex items-center gap-3"
 >
                    Próximo
