        ...
        <div className="sticky top-2 md:top-20 z-[400] mx-4 md:mx-0">
            <div className="bg-background/60 border border-border/60 rounded-2xl px-4 py-3 shadow-black/40">
                <div className="flex items-center justify-between relative">
                    {/* Connecting line */}
                    <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-px bg-foreground/[0.03] mx-8 hidden sm:block" />
                            ...
                            >
                                ...
                                <div
                                    className={cn(
                                        ...
                                        isActive && 'bg-indigo-500/30 text-indigo-300 border border-indigo-500/40 scale-110',
                                        isPending && 'bg-foreground/[0.03] text-muted-foreground border border-border/60'
                                    )}
                                >
                                    {isCompleted ? (
                                ...
                                <span
                                    className={cn(
                                        'text-xs md:text-[11px] font-semibold transition-all duration-300 hidden sm:block',
                                ...
                                {isActive && (
                                    <span className="sm:hidden text-xs font-semibold text-indigo-300">
                                        {step.label}
                                    </span>
                                )}
                            </div>
