...
export default function RegisterPaymentButton({ customers, orders, companyId }: Props) {
 ...
 className="group relative flex items-center gap-3 bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 rounded-2xl text-xs font-semibold transition active:scale-95"
 >
                    ...
                    >
                        ...
                        <div className="relative p-10">
                            <div className="flex items-center justify-between mb-10">
                                ...
                                <button
                                    onClick={() => setOpen(false)}
                                    className="p-3 hover:bg-foreground/[0.05] rounded-2xl transition text-muted-foreground hover:text-foreground"
                                >
                                    <X className="w-6 h-6" />
                                </button>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-2">
                                        <label className="flex items-center gap-2 text-[13px] font-medium text-muted-foreground ml-1">
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-muted/30 border border-border/60 rounded-2xl px-5 py-4 text-xs font-bold text-foreground focus:outline-none focus:border-primary/40 transition appearance-none cursor-pointer"
                                        >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-muted/30 border border-border/60 rounded-2xl px-5 py-6 text-2xl font-black text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-emerald-500/40 transition font-mono"
                                            placeholder="0,00"
                                        />
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    {/* Status */}
                                    <div className="space-y-2">
                                        <label className="text-[13px] font-medium text-muted-foreground ml-1">Status</label>
 ...
 className={cn(
 "flex-1 py-3 rounded-xl text-[13px] font-semibold border transition",
 ...
 >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-muted/30 border border-border/60 rounded-2xl px-5 py-4 text-xs font-bold text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary/40 transition"
 ...
 type="button"
 onClick={() => setOpen(false)}
 className="h-16 px-10 rounded-2xl border border-border/60 text-[13px] font-semibold text-muted-foreground hover:bg-foreground/[0.05] transition"
 >
                                        Cancelar
                                    </button>
                                    <button
 type="submit"
 disabled={isPending}
 className="flex-1 h-16 bg-primary hover:bg-primary/90 disabled:opacity-50 text-white rounded-2xl text-[13px] font-semibold transition active:scale-95 flex items-center justify-center gap-3"
 >
