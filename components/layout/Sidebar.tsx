...
const navItems = [
    ...
    { href: '/payments', label: 'Financeiro', icon: CreditCard, roles: ['admin', 'manager'] },
    { href: '/cash-register', label: 'Caixa', icon: Wallet, roles: ['admin'] },
...
export default function Sidebar({ userRole = 'admin' }: { userRole?: UserRole }) {
    ...
    // Prevent hydration mismatch by using server default (true) until mounted
    ...
    return (
        <>
            ...
            >
                {/* Logo */}
                <div className="h-20 flex items-center px-6 border-b border-border shrink-0 relative overflow-hidden bg-background/30">
                    <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-transparent" />
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-blue-600 flex items-center justify-center shrink-0 shadow-lg shadow-primary/20 relative z-10 transition-transform hover:rotate-6">
                ...
                {/* Bottom user area */}
                <div className="p-4 border-t border-border shrink-0 bg-gradient-to-b from-transparent to-foreground/5 dark:to-black/20 min-h-[5rem]">
                    {mounted ? (
