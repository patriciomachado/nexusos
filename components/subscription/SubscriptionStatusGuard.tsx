    ...
    return (
        <div className="relative min-h-screen">
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-background/60 backdrop-blur-md p-4 animate-in fade-in duration-500">
                <Card className="max-w-md w-full p-8 text-center space-y-6 border-primary/20 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="flex flex-col gap-3 pt-2">
                        <Button asChild size="lg" className="w-full font-semibold shadow-lg shadow-primary/20 transition-all hover:scale-[1.02] active:scale-100">
